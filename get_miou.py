...
val_cfg = dict(
    ...
    model_path="./logs/deeplabv3plus_fusion/09_DeepLabV3Plus_fusion_version2_MobileVit_d4_Bigger_f3_500epochs_bs16_adam/last_epoch_weights.pth",
    ...
    file_name="train.txt",
    save_file_dir="./miou_out_train_last",
)
